...
const AlertDialogDescriptionIdContext = React.createContext<string | undefined>(undefined)
...
function AlertDialogContent({
  ...
  // Generate a unique ID for description if AlertDialogDescription is used
  const descriptionId = React.useId()
  const [hasDescription, setHasDescription] = React.useState(false)

  // Check if AlertDialogDescription is in children
  React.useEffect(() => {
...
function AlertDialogDescription({
  ...
  const contextId = React.useContext(AlertDialogDescriptionIdContext)
