...
VALUES
('user-admin-001', 'admin@scommerce.com', 'Admin User', '+8801700000001', '$2a$10$xyz123', 1, 'admin', datetime('now'), datetime('now'));

-- Staff users
INSERT OR IGNORE INTO users (id, email, name, phone, password, emailVerified, role, createdAt, updatedAt)
VALUES
('user-staff-001', 'rahul@scommerce.com', 'Rahul Sharma', '+8801700000002', '$2a$10$xyz123', 1, 'staff', datetime('now'), datetime('now')),
('user-staff-002', 'priya@scommerce.com', 'Priya Singh', '+8801700000003', '$2a$10$xyz123', 1, 'staff', datetime('now'), datetime('now')),
('user-staff-003', 'amit@scommerce.com', 'Amit Kumar', '+8801700000004', '$2a$10$xyz123', 1, 'staff', datetime('now'), datetime('now'));

-- Customer users
INSERT OR IGNORE INTO users (id, email, name, phone, password, emailVerified, role, createdAt, updatedAt)
VALUES
('user-cust-001', 'fatema@example.com', 'Fatema Akhter', '+8801700000101', '$2a$10$xyz123', 1, 'user', datetime('now'), datetime('now')),
('user-cust-002', 'noor@example.com', 'Noor Jahan', '+8801700000102', '$2a$10$xyz123', 1, 'user', datetime('now'), datetime('now')),
('user-cust-003', 'sara@example.com', 'Sara Ahmed', '+8801700000103', '$2a$10$xyz123', 1, 'user', datetime('now'), datetime('now')),
('user-cust-004', 'zara@example.com', 'Zara Khan', '+8801700000104', '$2a$10$xyz123', 1, 'user', datetime('now'), datetime('now')),
('user-cust-005', 'hana@example.com', 'Hana Begum', '+8801700000105', '$2a$10$xyz123', 1, 'user', datetime('now'), datetime('now'));
